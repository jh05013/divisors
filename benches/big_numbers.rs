...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench_function(&format!("finding divisors of {} with get_divisors", n0),
                     |b| b.iter(|| divisors::get_divisors(black_box(12345678956u64))));
    c.bench_function(&format!("finding divisors of {} with get_divisors_standard", n0),
                     |b| b.iter(|| get_divisors_standard(black_box(12345678956u64))));

    c.bench_function(&format!("finding divisors of {} with get_divisors", n1),
                     |b| b.iter(|| divisors::get_divisors(black_box(193291493211u64))));
    c.bench_function(&format!("finding divisors of {} with get_divisors_standard", n1),
                     |b| b.iter(|| get_divisors_standard(black_box(93291493211u64))));

    c.bench_function(&format!("finding divisors of {} with get_divisors", n2),
                     |b| b.iter(|| divisors::get_divisors(black_box(11111111111u64))));
    c.bench_function(&format!("finding divisors of {} with get_divisors_standard", n2),
